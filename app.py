...
if cfg_enable_url_download:
    url = "https://archive.org/download/best-6/best%20%286%29.pt" #Configure this if you set cfg_enable_url_download to True
...
def main():
    ...
    st.sidebar.markdown("https://github.com/ruchi-1822/FInal-year-Project")
    if option == "Image":    
